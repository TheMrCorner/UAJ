...
public enum FileType { Json, Binary}
public class Tracker
{
    ...
    public void InitSaveFile(FileType type)
    {
        switch (type)
        {
            case FileType.Json:
    ...
    private void InitBinary()
    {
        ...
        if (_fileName == "")
        {
            ...
            {
                // counts only json files, not the autogenerated metas
                numPlaysToday = Directory.GetFiles(TELEMETRY_PATH, "*.bn").Length;
            }
            else
            {
                Directory.CreateDirectory(TELEMETRY_PATH);
            ...
            _fileName = auxFileName + "_" + numPlaysToday;
            auxFilePath = TELEMETRY_PATH + "/" + _fileName + ".bn";
        }
    }
